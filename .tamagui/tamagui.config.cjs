...
var require_mutateTheme = __commonJS({
  "node_modules/@tamagui/theme/dist/cjs/_mutateTheme.js"(exports, module2) {
    ...
    function _mutateTheme(props) {
      ...
      const themeProxied = (0, import_web16.proxyThemeToParents)(themeName, theme, config.themes);
      config.themes[themeName] = themeProxied;
      let cssRules = [];
      (0, import_web16.updateConfig)("themes", { ...config.themes, [themeName]: themeProxied });
